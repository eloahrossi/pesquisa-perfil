...
target="_blank" rel="noreferrer">
          ...
          <a href={`https://github.com/${userData.public_repos}?tab=repositories`}
          target="_blank" rel="noreferrer">
            	<p>Repositórios públicos: {userData.public_repos}</p>
              </a>
              <a href={`https://github.com/${userData.followers}?tab=followers`}
              target="_blank" rel="noreferrer">
            	<p>Seguidores: {userData.followers}</p>
              </a>
              <a href={`https://github.com/${userData.following}?tab=following`}
              target="_blank" rel="noreferrer">
